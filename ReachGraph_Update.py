...
def AdjustReachGraph(Reachability_Graph_Mat, nodeA_clust_idx, nodeB_clust_idx, reln_type, outfile):    
	...
	if (reln_type == RELATION_R3):
		...
		"""
		Reachability_Graph_Mat = TransClosUpd(Reachability_Graph_Mat, nodeA_reach_mat_idx, nodeB_reach_mat_idx, RELATION_R1)
	elif (reln_type == RELATION_R2):
		"""
		connect the pair of clusters, along with updating the reachability matrix
		"""
		...
		now perform the transitive closure on the derived reachability matrix  
		"""
		Reachability_Graph_Mat = TransClosUpd(Reachability_Graph_Mat, nodeA_reach_mat_idx, nodeB_reach_mat_idx, RELATION_R2)    
		...
		now perform the transitive closure on the derived reachability matrix  
		"""
		Reachability_Graph_Mat = TransClosUpd(Reachability_Graph_Mat, nodeA_reach_mat_idx, nodeB_reach_mat_idx, RELATION_R4)    
